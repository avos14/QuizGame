...
public class Quiz implements ActionListener {
    ...
    String[][] options = {
            ...
            {"Oxford","Mit","Harvard","Berkeley"},
            {"2010","2007","2008","2004"},
            {"Ask","Yahoo","Baidu","Archie"},
            {"SpaceX","Starburst","Star Force","Astro Exploration"},
            {"The Wright Brothers","The Marx Brothers","The Grimm Brothers","The Jonas Brothers"},
            {"Moon","Water","Sun","Coal"},
            {"Alan Turing","Tony Hoare","Tim Berners-Lee","Robin Milner"},
            {"Shoes","Books","Computers","Magazines"}
